...
export const UpdateProductCart = createAction(
  UpdateProductCartType,
  props<{ article: ArticleItemResponse; quantity: number }>()
);

export const RefreshCartStockType = '[Cart] Refresh the stock of the products in the cart';
export const RefreshCartStock = createAction(RefreshCartStockType, props<{ articles: ArticleItemResponse[] }>());

export const setTotalType = '[Cart] Set total to cart';
export const setTotal = createAction(setTotalType, props<{ total: number | null }>());

export const RemoveProductCartType = '[Cart] Remove product from cart';
export const RemoveProductCart = createAction(RemoveProductCartType, props<{ code: string }>());
...
export const CheckedOut = createAction(CheckedOutType, props<{ response: any }>());
